...
import com.example.waynewei.foodgame.service.DownloadCompleted;
import com.example.waynewei.foodgame.service.DownloadMusic;
	...
	public void playAudio(){
		...
		if(loaded) {
			if (mPlayer.isPlaying()) {
				...
				mPlayer.pause();
				fab.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_play_arrow_white_24dp));
				fab.setColorNormal(mContext.getResources().getColor(R.color.colorPrimary));
			} else {
				Log.d("test", "play");
...
//				fab.setColorNormal(mContext.getResources().getColor(R.color.md_cyan_700));
	...
	public void stopAudio(){
		if (loaded) {
			fab.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_stop_white_24dp));
			fab.setColorNormal(mContext.getResources().getColor(R.color.colorPrimary));
			fabProgressCircle.hide();
			mPlayer.seekTo(0);
			mPlayer.pause();
